...
for(let i = 0; i < meal.length; i++) {
    mealInfoBox += '<div class="mealInfo Hflex-center clickable"><div class="mealIntro"><span class="fontsizeTwo"><b>' + meal[i] + '</b></span><br><span class="fontsizeThree" style="color: gray;">點擊查看</span></div><img src="media/photos/meals/' + meal[i] + '.jpg"></div>'
