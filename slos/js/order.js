var table = '<tr><th>日期</th><th>星期</th><th>A餐</th><th>B餐</th><th>C餐</th><th>D餐</th><th>選擇</th></tr>'
...
for(let i = 1; i <= daysInMonth; i++) {
    ...
    if(day == 6 || day == 0) {
        ...
        table += '<tr><td class="orderDate">' + month + '月' + String(i) + '日</td><td class="orderDate">' + chineseWeekday[day - 1] + '</td><td id=' + String(year) + '-' + String(month) +  '-' + String(i) + '-A>' + meal[mealNumber] + '</td><td id=' + String(year) + '-' + String(month) +  '-' + String(i) + '-B> ' + meal[mealNumber + 1] + '</td><td id=' + String(year) + '-' + String(month) +  '-' + String(i) + '-C>' + meal[mealNumber + 2] + '</td><td id=' + String(year) + '-' + String(month) +  '-' + String(i) + '-D>' + meal[mealNumber + 3] + '</td><td><select id= "' + String(year) + '-' + String(month) +  '-' + String(i) + '-select" onchange="showSelect(' + String(year) + ',' + String(month) + ',' + String(i) + ');"><option value="-">-</option><option value="A">A</option><option value="B">B</option><option value="C">C</option><option value="D">D</option></select></td></tr>';
