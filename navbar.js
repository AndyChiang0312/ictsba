document.getElementById('navpage').innerHTML = '<a href="index.html"><img src="media/icons/logo.png" width="50px"></a><br><a href="login.html" class="fontsizeOne">學生訂餐</a><br><a class="fontsizeOne">聯絡我們</a>';
document.getElementById('navbar').innerHTML = '<div id="navbutton" class="clickable"><img src="media/icons/menu.png" id="navbuttonOne"><img src="media/icons/close.png" id="navbuttonTwo"></div><a href="index.html" class="clickable">主頁</a><a href="login.html" class="clickable">學生訂餐</a><a>聯絡我們</a>';
